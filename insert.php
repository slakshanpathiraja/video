...
if (mysqli_connect_errno($conn)){
  ...
  echo "Database Connected";
    ...
    $query_add = "INSERT INTO `video`(`id`, `v_id`, `v_title`, `v_url`, `i_url`, `v_time`, `v_view`) VALUES(NULL,'{$video_id}','{$video_title}','{$video_url}','{$video_image_url}','{$video_time}','{$video_view}');";
